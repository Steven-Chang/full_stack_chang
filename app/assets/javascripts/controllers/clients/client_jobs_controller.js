app.controller('ClientJobsController', ['$filter', '$ngConfirm', '$rootScope', '$scope', '$state', '$timeout', 'AlertService', 'Auth', 'DatetimeService', 'DisplayService', 'Restangular', function( $filter, $ngConfirm, $rootScope, $scope, $state, $timeout, AlertService, Auth, DatetimeService, DisplayService, Restangular ){
