...
!(function (t, n) {
  ...
  var n = (function () {
        ...
        n(t, [
          ...
          },
          {
            ...
            value: function (t, n) {
              ...
              a(e)
                ? e.call(this, t, i, n)
                : a(i.fn) && i.fn.call(t || window, i.data),
    ...
    f = {
      ...
      trigger: function (e) {
        var i = this.current;
        (this.current = e),
          this.callbacks.fire(e, function (t, n) {
            a(n.fn) && n.fn.call({ current: e, previous: i }, n.data);
          });
      },
      one: function (t, n) {
      ...
      on: function (t, n) {
        ...
        void 0 === n && a(t) && ((n = t), (t = void 0)),
          a(n) && this.callbacks.add(n, t, e);
      },
      off: function (t) {
        ...
        n(e, [
          {
            key: "initialize",
            value: function () {
              (this.callbacks = { enter: new c(), leave: new c() }),
    ...
    d = {
      ...
      between: function (t, n) {
        var e =
          2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : "px";
    ...
    v = (function (t) {
      function a(t) {
        ...
        var r = d.get(n, e, i),
          o = u(
            this,
            (a.__proto__ || Object.getPrototypeOf(a)).call(this, t, r)
          );
        ...
        return (
          ...
          o.isMatched() && (f.current = o),
          o.mql.addListener(o.changeListener),
          o
        );
      }
      return (
    ...
    p = (function (t) {
      function n(t) {
        ...
        var i = [],
          r = [];
        return (
          s(t.split(" "), function (t, n) {
            var e = b.get(n);
            e && (i.push(e), r.push(e.media));
          }),
          u(
            this,
            (n.__proto__ || Object.getPrototypeOf(n)).call(this, t, r.join(","))
          )
        );
      }
      return e(n, h), n;
  ...
  var b = (g = r(g, {
    ...
    define: function (t) {
      ...
      for (var e in (this.defined && this.destroy(),
      t || (t = g.defaults),
      (this.options = r(n, { unit: "px" })),
      t))
        t.hasOwnProperty(e) &&
      ...
      var n =
        ...
        e =
          2 < arguments.length && void 0 !== arguments[2]
            ...
            : 1 / 0,
        i =
          3 < arguments.length && void 0 !== arguments[3] ? arguments[3] : "px",
        r = this.get(t);
