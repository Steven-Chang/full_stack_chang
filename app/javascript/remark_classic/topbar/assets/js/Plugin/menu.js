(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define("/Plugin/menu", ["remark_classic/global/js/Plugin"], factory);
              ...
              switch (flag) {
                case "on":
                  $(document).on("click.site.menu", function (e) {
                    if (
                      $('.dropdown > [data-dropdown-toggle="true"]').length > 0
                    ) {
