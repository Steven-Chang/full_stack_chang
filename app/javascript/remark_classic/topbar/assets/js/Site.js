(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define("/Site", [
      "exports",
      "jquery",
      "remark_classic/global/js/Base",
      "remark_classic/topbar/assets/js/Section/Menubar",
      "remark_classic/topbar/assets/js/Section/Sidebar",
      "remark_classic/topbar/assets/js/Section/PageAside",
    ], factory);
      ...
      babelHelpers.createClass(Site, [
        ...
        },
        {
          ...
          value: function setupMenubar() {
            ...
            (0, _jquery.default)(document).on(
              "collapsed.site.menu expanded.site.menu",
              function () {
                var type = _this.menubar.type;
