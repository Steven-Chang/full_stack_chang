...
Credential.find_by(identifier: 'change_superfund_2').trade_pairs.find_by(symbol: 'ethbtc').orders.where(status: 'filled', buy_or_sell: 'buy').order(price: :asc).find_each do |order|
